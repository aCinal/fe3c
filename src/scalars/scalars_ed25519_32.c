...
static void ed25519_scalar_reduce(u8 * s) {
    ...
    i64 t0,  t1,  t2,  t3,  t4,  t5,  t6,  t7,  t8,  t9,  t10, t11;
    i64 t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23;

    /* Parse the scalar into limbs */
    t0  = ( load_24(&s[ 0]) >> 0 ) & LOW_21_BITS_MASK;
    ...
    t1  = ( load_32(&s[ 2]) >> 5 ) & LOW_21_BITS_MASK;
     ...
     * add 1 to the offset). */
    t2  = ( load_24(&s[ 5]) >> 2 ) & LOW_21_BITS_MASK;
    /* Whenever shift is larger than 3 we need to load 32 bits */
    t3  = ( load_32(&s[ 7]) >> 7 ) & LOW_21_BITS_MASK;
    t4  = ( load_32(&s[10]) >> 4 ) & LOW_21_BITS_MASK;
    t5  = ( load_24(&s[13]) >> 1 ) & LOW_21_BITS_MASK;
    t6  = ( load_32(&s[15]) >> 6 ) & LOW_21_BITS_MASK;
    t7  = ( load_24(&s[18]) >> 3 ) & LOW_21_BITS_MASK;
    t8  = ( load_24(&s[21]) >> 0 ) & LOW_21_BITS_MASK;
    t9  = ( load_32(&s[23]) >> 5 ) & LOW_21_BITS_MASK;
    t10 = ( load_24(&s[26]) >> 2 ) & LOW_21_BITS_MASK;
    t11 = ( load_32(&s[28]) >> 7 ) & LOW_21_BITS_MASK;
    t12 = ( load_32(&s[31]) >> 4 ) & LOW_21_BITS_MASK;
    t13 = ( load_24(&s[34]) >> 1 ) & LOW_21_BITS_MASK;
    t14 = ( load_32(&s[36]) >> 6 ) & LOW_21_BITS_MASK;
    t15 = ( load_24(&s[39]) >> 3 ) & LOW_21_BITS_MASK;
    t16 = ( load_24(&s[42]) >> 0 ) & LOW_21_BITS_MASK;
    t17 = ( load_32(&s[44]) >> 5 ) & LOW_21_BITS_MASK;
    t18 = ( load_24(&s[47]) >> 2 ) & LOW_21_BITS_MASK;
    t19 = ( load_32(&s[49]) >> 7 ) & LOW_21_BITS_MASK;
    t20 = ( load_32(&s[52]) >> 4 ) & LOW_21_BITS_MASK;
    t21 = ( load_24(&s[55]) >> 1 ) & LOW_21_BITS_MASK;
    t22 = ( load_32(&s[57]) >> 6 ) & LOW_21_BITS_MASK;
...
static int ed25519_scalar_is_canonical(const u8 s[32]) {
    ...
    /* Load the scalar into eight 32-bit words */
...
static void ed25519_scalars_muladd(u8 * r, const u8 * a, const u8 * b, const u8 * c) {
    ...
    a0  = ( load_24(&a[ 0]) >> 0 ) & LOW_21_BITS_MASK;
    /* Two full bytes were written into t0 as well as five additional bits. Skip the two
     * bytes by offsetting into the array and skip the five bits by shifting (note that
     * we need to load four bytes since if we loaded only three, shift would rob us of
     * 5 bits and we would be left with only 19 bits). */
    a1  = ( load_32(&a[ 2]) >> 5 ) & LOW_21_BITS_MASK;
    /* Offset by another 21 bits at each step, i.e. by two additional bytes and five bits
     * of shift (note that the number of shifts is modulo 8 - instead of shifting by 8 we
     * add 1 to the offset). */
    a2  = ( load_24(&a[ 5]) >> 2 ) & LOW_21_BITS_MASK;
    /* Whenever shift is larger than 3 we need to load 32 bits */
    a3  = ( load_32(&a[ 7]) >> 7 ) & LOW_21_BITS_MASK;
    a4  = ( load_32(&a[10]) >> 4 ) & LOW_21_BITS_MASK;
    a5  = ( load_24(&a[13]) >> 1 ) & LOW_21_BITS_MASK;
    a6  = ( load_32(&a[15]) >> 6 ) & LOW_21_BITS_MASK;
    a7  = ( load_24(&a[18]) >> 3 ) & LOW_21_BITS_MASK;
    a8  = ( load_24(&a[21]) >> 0 ) & LOW_21_BITS_MASK;
    a9  = ( load_32(&a[23]) >> 5 ) & LOW_21_BITS_MASK;
    a10 = ( load_24(&a[26]) >> 2 ) & LOW_21_BITS_MASK;
    a11 = ( load_32(&a[28]) >> 7 );

    /* Repeat the same steps for b and c */
    b0  = ( load_24(&b[ 0]) >> 0 ) & LOW_21_BITS_MASK;
    b1  = ( load_32(&b[ 2]) >> 5 ) & LOW_21_BITS_MASK;
    b2  = ( load_24(&b[ 5]) >> 2 ) & LOW_21_BITS_MASK;
    b3  = ( load_32(&b[ 7]) >> 7 ) & LOW_21_BITS_MASK;
    b4  = ( load_32(&b[10]) >> 4 ) & LOW_21_BITS_MASK;
    b5  = ( load_24(&b[13]) >> 1 ) & LOW_21_BITS_MASK;
    b6  = ( load_32(&b[15]) >> 6 ) & LOW_21_BITS_MASK;
    b7  = ( load_24(&b[18]) >> 3 ) & LOW_21_BITS_MASK;
    b8  = ( load_24(&b[21]) >> 0 ) & LOW_21_BITS_MASK;
    b9  = ( load_32(&b[23]) >> 5 ) & LOW_21_BITS_MASK;
    b10 = ( load_24(&b[26]) >> 2 ) & LOW_21_BITS_MASK;
    b11 = ( load_32(&b[28]) >> 7 );

    c0  = ( load_24(&c[ 0]) >> 0 ) & LOW_21_BITS_MASK;
    c1  = ( load_32(&c[ 2]) >> 5 ) & LOW_21_BITS_MASK;
    c2  = ( load_24(&c[ 5]) >> 2 ) & LOW_21_BITS_MASK;
    c3  = ( load_32(&c[ 7]) >> 7 ) & LOW_21_BITS_MASK;
    c4  = ( load_32(&c[10]) >> 4 ) & LOW_21_BITS_MASK;
    c5  = ( load_24(&c[13]) >> 1 ) & LOW_21_BITS_MASK;
    c6  = ( load_32(&c[15]) >> 6 ) & LOW_21_BITS_MASK;
    c7  = ( load_24(&c[18]) >> 3 ) & LOW_21_BITS_MASK;
    c8  = ( load_24(&c[21]) >> 0 ) & LOW_21_BITS_MASK;
    c9  = ( load_32(&c[23]) >> 5 ) & LOW_21_BITS_MASK;
    c10 = ( load_24(&c[26]) >> 2 ) & LOW_21_BITS_MASK;
    c11 = ( load_32(&c[28]) >> 7 );
    ...
    t6  = c6  + a0*b6  + a1*b5  + a2*b4  + a3*b3  + a4*b2  + a5*b1  + a6*b0;
    t7  = c7  + a0*b7  + a1*b6  + a2*b5  + a3*b4  + a4*b3  + a5*b2  + a6*b1  + a7*b0;
    t8  = c8  + a0*b8  + a1*b7  + a2*b6  + a3*b5  + a4*b4  + a5*b3  + a6*b2  + a7*b1  + a8*b0;
    t9  = c9  + a0*b9  + a1*b8  + a2*b7  + a3*b6  + a4*b5  + a5*b4  + a6*b3  + a7*b2  + a8*b1  + a9*b0;
    t10 = c10 + a0*b10 + a1*b9  + a2*b8  + a3*b7  + a4*b6  + a5*b5  + a6*b4  + a7*b3  + a8*b2  + a9*b1  + a10*b0;
    t11 = c11 + a0*b11 + a1*b10 + a2*b9  + a3*b8  + a4*b7  + a5*b6  + a6*b5  + a7*b4  + a8*b3  + a9*b2  + a10*b1  + a11*b0;
    t12 =                a1*b11 + a2*b10 + a3*b9  + a4*b8  + a5*b7  + a6*b6  + a7*b5  + a8*b4  + a9*b3  + a10*b2  + a11*b1;
    t13 =                         a2*b11 + a3*b10 + a4*b9  + a5*b8  + a6*b7  + a7*b6  + a8*b5  + a9*b4  + a10*b3  + a11*b2;
    t14 =                                  a3*b11 + a4*b10 + a5*b9  + a6*b8  + a7*b7  + a8*b6  + a9*b5  + a10*b4  + a11*b3;
    t15 =                                           a4*b11 + a5*b10 + a6*b9  + a7*b8  + a8*b7  + a9*b6  + a10*b5  + a11*b4;
    t16 =                                                    a5*b11 + a6*b10 + a7*b9  + a8*b8  + a9*b7  + a10*b6  + a11*b5;
    t17 =                                                             a6*b11 + a7*b10 + a8*b9  + a9*b8  + a10*b7  + a11*b6;
    t18 =                                                                      a7*b11 + a8*b10 + a9*b9  + a10*b8  + a11*b7;
    t19 =                                                                               a8*b11 + a9*b10 + a10*b9  + a11*b8;
    t20 =                                                                                        a9*b11 + a10*b10 + a11*b9;
    t21 =                                                                                                 a10*b11 + a11*b10;
    t22 =                                                                                                           a11*b11;
    /* Leave t23 for any overflows */
    t23 = 0;
    ...
    t4  -= t12 * GROUP_ORDER_LIMB_4;
    t5  -= t12 * GROUP_ORDER_LIMB_5;
    /* t12 is fully distributed among lower limbs and we will need it
     * for handling overflow in t11. Clear it here to prepare it for
     * this purpose. */
    t12 = 0;
    t1  += t0  >> 21;  t0  &= LOW_21_BITS_MASK;
    t2  += t1  >> 21;  t1  &= LOW_21_BITS_MASK;
