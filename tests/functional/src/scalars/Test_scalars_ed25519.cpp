...
FE3C_TEST(SCALARS_ED25519, Reduce_AllBitsAboveOrderSet_ReduceCorrectly)
{
    ...
    const u8 expected[] = {
        0xdb, 0xb6, 0x87, 0xfe, 0x17, 0xd8, 0x2a, 0x54,
        0xf4, 0xcc, 0x74, 0xae, 0x64, 0x0f, 0xcc, 0xf9,
        0x65, 0xbe, 0xf5, 0x17, 0xd2, 0x73, 0xec, 0xce,
        0x3d, 0x9a, 0x30, 0x7c, 0x1b, 0x41, 0x99, 0x03
    };
    ed25519_scalar_ops.reduce(input);
...
FE3C_TEST(SCALARS_ED25519, Reduce_AllBitsAbove256Set_ReduceCorrectly)
{
    ...
    const u8 expected[] = {
        0xd1, 0x4d, 0xf9, 0x13, 0x89, 0x43, 0x2c, 0x25,
        0xad, 0x60, 0xff, 0x97, 0x91, 0xb9, 0xfd, 0x1d,
        0x67, 0xbe, 0xf5, 0x17, 0xd2, 0x73, 0xec, 0xce,
        0x3d, 0x9a, 0x30, 0x7c, 0x1b, 0x41, 0x99, 0x03
    };
    ed25519_scalar_ops.reduce(input);
    FAIL_IF_MEMCMP(expected, input, sizeof(expected));
